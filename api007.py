...
if hist_criteria:
  ...
  fromdate = st.sidebar.datetime_input("Choose From Date", format="YYYY-MM-DD", key='fromdate')
  todate = st.sidebar.datetime_input("Choose To Date", format="YYYY-MM-DD", key='todate')
